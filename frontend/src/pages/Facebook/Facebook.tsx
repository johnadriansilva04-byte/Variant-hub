...
export default function Facebook() {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <Panel collapsible defaultOpen title="Página do Facebook" className="rounded-2xl">
      ...
      <Panel collapsible defaultOpen={false} title="Publicações" className="rounded-2xl">
        <div className="text-center py-8">
      ...
      <Panel collapsible defaultOpen={false} title="Messenger" className="rounded-2xl">
        <div className="text-center py-8">
