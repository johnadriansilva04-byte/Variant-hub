...
export default function Instagram() {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <Panel collapsible defaultOpen title="Perfil do Instagram" className="rounded-2xl">
      ...
      <Panel collapsible defaultOpen={false} title="Top Posts" className="rounded-2xl">
        <div className="text-center py-8">
      ...
      <Panel collapsible defaultOpen={false} title="Mensagens que pedem atenção" className="rounded-2xl">
        <div className="text-center py-8">
