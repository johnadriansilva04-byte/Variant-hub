...
export default function Telegram() {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <Panel title="Canal do Telegram" className="rounded-2xl">
      ...
      <Panel title="Broadcasts Recentes" className="rounded-2xl">
        <div className="text-center py-8">
      ...
      <Panel title="Automação do Canal" className="rounded-2xl">
        <div className="text-center py-8">
