...
export default function Telegram() {
  const { status } = useIntegrationStatus('telegram')

  return (
    <div className="space-y-6 animate-fade-in">
      <PageHeader
        zone="calcada"
        zoneLabel="CALÇADA · Telegram"
        title="Analytics Telegram"
        description="Acompanhe o desempenho do Telegram na geração de tráfego para o WhatsApp."
        right={
      ...
      <Panel collapsible defaultOpen title="Canal do Telegram" className="rounded-2xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Panel collapsible defaultOpen={false} title="KPIs da Semana" className="rounded-2xl">
        ...
        <Panel collapsible defaultOpen={false} title="Funil da Semana" className="rounded-2xl">
      ...
      <Panel collapsible defaultOpen={false} title="Broadcasts Recentes" className="rounded-2xl">
        <div className="text-center py-8">
          <p className="text-sm text-dark-400">Nenhum broadcast ainda</p>
          <p className="text-xs text-dark-500 mt-1">Configure a integração para começar</p>
        </div>
      </Panel>

      <Panel collapsible defaultOpen={false} title="Automação do Canal" className="rounded-2xl">
        <div className="text-center py-8">
          <p className="text-sm text-dark-400">Nenhum bot configurado</p>
          <p className="text-xs text-dark-500 mt-1">Configure a integração para começar</p>
        </div>
      </Panel>
    </div>
