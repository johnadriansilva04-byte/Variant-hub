...
export default function TikTok() {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <Panel collapsible defaultOpen title="Perfil do TikTok" className="rounded-2xl">
      ...
      <Panel collapsible defaultOpen={false} title="Vídeos que Performaram" className="rounded-2xl">
        <div className="text-center py-8">
      ...
      <Panel collapsible defaultOpen={false} title="Insights do que Funciona" className="rounded-2xl">
        <div className="text-center py-8">
